...
<p align="center">
  <img src="https://github.com/cielly-nunes/AmigoSecreto/blob/main/assets/printchallenge.png" alt="Demonstração do projeto Amigo Secreto" width="700"/>
</p>
...
```bash
   git clone https://github.com/cielly-nunes/ChallengeAlura-Amigo-Secreto
```

2. **Navegue até o diretório do projeto:**
  ```bash
     cd ChallengeAlura-Amigo-Secreto
  ```
